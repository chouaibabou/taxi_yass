  ...
  return (
    <section id="faq" className="bg-white py-20">
      <div className="mx-auto max-w-4xl px-4 sm:px-6 lg:px-8">
        <p className="text-sm font-black uppercase tracking-wide text-taxi-gold">FAQ</p>
        <h2 className="mt-2 text-3xl font-black text-taxi-black sm:text-4xl">Questions frequentes</h2>
