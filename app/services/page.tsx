...
export const metadata = pageMetadata(
  "Services taxi Château-Thierry - Taxi conventionné, gares, aéroports et entreprise",
  "Découvrez les services Yas'Taxii dans l'agglomération de Château-Thierry : taxi conventionné, transferts aéroports CDG Orly Beauvais, gares, trajets professionnels, tourisme et assistance.",
  "/services"
);
