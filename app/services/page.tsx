...
export const metadata = pageMetadata(
  "Services taxi Chateau-Thierry - Taxi conventionne, gares, aeroports et entreprise",
  "Decouvrez les services Yas'Taxii a Chateau-Thierry : taxi conventionne, transferts aeroports CDG Orly Beauvais, gares, professionnels, tourisme et assistance.",
  "/services"
);
    ...
    <>
      <section className="relative isolate overflow-hidden bg-taxi-black py-20 text-white">
        ...
        <div className="relative mx-auto grid max-w-7xl gap-10 px-4 sm:px-6 lg:grid-cols-[0.9fr_1.1fr] lg:px-8">
          <div className="grid content-center">
            ...
            <h1 className="mt-3 text-4xl font-black leading-tight sm:text-5xl">Taxi conventionne, navettes et toutes distances</h1>
            <p className="mt-5 max-w-2xl text-lg leading-8 text-white/75">
              Une page dediee pour mieux presenter chaque service et renforcer le referencement local autour de Chateau-Thierry, l&apos;Aisne, les gares et les aeroports.
            </p>
            <div className="mt-8 flex flex-col gap-3 sm:flex-row">
              <ButtonLink href="/#reserver">Reserver / demander un devis</ButtonLink>
        ...
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <div className="flex flex-col justify-between gap-6 md:flex-row md:items-end">
            <div className="max-w-3xl">
              <p className="text-sm font-black uppercase tracking-wide text-taxi-gold">Nos differents services</p>
              ...
              <p className="mt-4 leading-7 text-neutral-600">
                Quelle que soit votre destination, Yas&apos;Taxii organise votre trajet avec ponctualite, confort et serieux, dans l&apos;Aisne et vers les departements voisins.
              </p>
            </div>
            <div className="rounded-lg bg-taxi-black p-4 text-white">
              <div className="text-3xl font-black text-taxi-gold">24/7</div>
              <div className="text-sm font-bold text-white/75">Reservation et devis rapide</div>
            </div>
          </div>
              ...
              <a key={id} href={`#${slug}`} className="group overflow-hidden rounded-lg border border-neutral-200 bg-white shadow-sm transition duration-300 hover:-translate-y-1 hover:shadow-xl">
                ...
                <div className="grid gap-3 p-5">
                  ...
                  <span className="inline-flex items-center gap-2 text-sm font-black text-taxi-black">
                    Details <ArrowRight className="transition group-hover:translate-x-1" size={16} />
                  </span>
                </div>
              </a>
            ))}
      ...
      <section className="bg-taxi-cream py-20">
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <div className="mb-10 max-w-3xl">
            <p className="text-sm font-black uppercase tracking-wide text-taxi-gold">Details SEO</p>
            <h2 className="mt-2 text-3xl font-black text-taxi-black sm:text-4xl">Chaque service en detail</h2>
          </div>
      ...
      <section className="bg-neutral-950 py-20 text-white">
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <div className="flex flex-col justify-between gap-6 md:flex-row md:items-end">
            <div className="max-w-3xl">
              <p className="text-sm font-black uppercase tracking-wide text-taxi-gold">Vehicules disponibles</p>
              <h2 className="mt-2 text-3xl font-black sm:text-4xl">Eco et Van pour adapter le trajet au nombre de passagers</h2>
              <p className="mt-4 text-white/70">Une flotte simple a comprendre, orientee confort, bagages et trajets toutes distances.</p>
            </div>
            ...
            {fleet.map(({ id, name, passengers, luggage, description, image }) => (
              <Card key={id} className="overflow-hidden border-white/10 bg-white/[0.06] text-white shadow-2xl">
                <div className="relative h-64 bg-[radial-gradient(circle_at_50%_20%,rgba(244,176,0,0.16),transparent_45%),linear-gradient(180deg,#ffffff,#f4f4f4)]">
                  <Image src={image} alt={`Vehicule ${name} Yas'Taxii`} fill className="object-contain p-5" sizes="(min-width: 768px) 50vw, 100vw" />
